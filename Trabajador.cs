    ...
    namespace Proyecto.Personas
    {
        ...
        public class Trabajador : Persona, ITrabajador
        {
            ...
            public Trabajador(int idTrabajador, string afp, double sueldoBruto, double pasaje,
                ...
                string nombre, int telefono, string apellidoPaterno, string apellidoMaterno, DateTime fechaNacimiento) : base (rut, verificador, telefono, nombre, apellidoPaterno, apellidoMaterno, fechaNacimiento)
            {
